...
The uConsole requires specialized hardware support that is not available in the standard nixos-raspberrypi repository. This configuration uses the **OOM (Out-of-Memory) fork** of nixos-raspberrypi which includes:
